...
export declare class NumberAttributeMock implements Xrm.Page.NumberAttribute {
    ...
    constructor(attribute: Xrm.Page.Attribute, controls?: Xrm.Collection.ItemCollection<Xrm.Page.NumberControl>, integerAttributeFormat?: Xrm.Page.IntegerAttributeFormat, min?: number, max?: number, precision?: number);
